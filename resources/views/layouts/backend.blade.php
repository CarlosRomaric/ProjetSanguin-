...
<head>
    ...
    <link rel="icon" href="favicon.ico" type="image/x-icon">
	  ...
	  <!-- vector map CSS -->
    <link href="/assets-backend/vendors/vectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet" type="text/css" />
	
	  <link href="/assets-backend/vendors/apexcharts/dist/apexcharts.css" rel="stylesheet" type="text/css" />
	
    <!-- Toggles CSS -->
    <link href="/assets-backend/vendors/jquery-toggles/css/toggles.css" rel="stylesheet" type="text/css">
    <link href="/assets-backend/vendors/jquery-toggles/css/themes/toggles-light.css" rel="stylesheet" type="text/css">
	
	  <!-- Toastr CSS -->
    <link href="/assets-backend/vendors/jquery-toast-plugin/dist/jquery.toast.min.css" rel="stylesheet" type="text/css">

    <!-- Custom CSS -->
    <link href="/assets-backend/dist/css/style.css" rel="stylesheet" type="text/css">
    @yield('extra-css')
</head>
...
<body>
	...
	<div class="hk-wrapper hk-vertical-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar">
            ...
            <a class="navbar-brand font-weight-700" href="/backend">
               Projet Sanguis
            </a>
                        ...
                        <div class="notifications-nicescroll-bar">
                                ...
                                <div class="media">
                                    <div class="media-img-wrap">
                                        <div class="avatar avatar-sm">
                                            <img src="/assets-backend/dist/img/avatar1.jpg" alt="user" class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item">
                                <div class="media">
                                    <div class="media-img-wrap">
                                        <div class="avatar avatar-sm">
                                            <img src="/assets-backend/dist/img/avatar2.jpg" alt="user" class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body">
                                        <div>
                ...
                <li class="nav-item dropdown dropdown-authentication">
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar">
                                    <img src="/assets-backend/dist/img/avatar12.jpg" alt="user" class="avatar-img rounded-circle">
                                </div>
                            ...
                            <ul id="Components_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('member.index') }}">Liste des Inscrits</a>
                                        </li>
        ...
        <div class="hk-settings-panel">
            ...
            <img class="d-none" src="/assets-backend/dist/img/logo-light.png" alt="brand" />
            <img class="d-none" src="/assets-backend/dist/img/logo-dark.png" alt="brand" />
        </div>
        <!-- /Setting Panel -->
        <!-- Main Content -->
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
						<h2 class="hk-pg-title font-weight-600 mb-10">Bienvenu sur la plateforme d'administration Projet Sanguis</h2>
                ...
                <footer class="footer">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <p>Projet Snaguis<a href="https://hencework.com/" class="text-dark" target="_blank">Improve by ImpactAfrique </a> © 2020</p>
                        </div>
                        <div class="col-md-6 col-sm-12">
    ...
    <script src="/assets-backend/dist/js/jquery.slimscroll.js"></script>

    <!-- Fancy Dropdown JS -->
    <script src="/assets-backend/dist/js/dropdown-bootstrap-extended.js"></script>

    <!-- FeatherIcons JavaScript -->
    <script src="/assets-backend/dist/js/feather.min.js"></script>

    <!-- Toggles JavaScript -->
    <script src="/assets-backend/vendors/jquery-toggles/toggles.min.js"></script>
    <script src="/assets-backend/dist/js/toggle-data.js"></script>
	
	<!-- Counter Animation JavaScript -->
	<script src="/assets-backend/vendors/waypoints/lib/jquery.waypoints.min.js"></script>
	<script src="/assets-backend/vendors/jquery.counterup/jquery.counterup.min.js"></script>
	...
	<!-- EChartJS JavaScript -->
    <script src="/assets-backend/vendors/echarts/dist/echarts-en.min.js"></script>
    
	<!-- Sparkline JavaScript -->
    <script src="/assets-backend/vendors/jquery.sparkline/dist/jquery.sparkline.min.js"></script>
	
	<!-- Vector Maps JavaScript -->
    <script src="/assets-backend/vendors/vectormap/jquery-jvectormap-2.0.3.min.js"></script>
    <script src="/assets-backend/vendors/vectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="/assets-backend/dist/js/vectormap-data.js"></script>


	  <!-- Owl JavaScript -->
    <script src="/assets-backend/vendors/owl.carousel/dist/owl.carousel.min.js"></script>
	
	  <!-- Toastr JS -->
    <script src="/assets-backend/vendors/jquery-toast-plugin/dist/jquery.toast.min.js"></script>
    
    <!-- Init JavaScript -->
    <script src="/assets-backend/dist/js/init.js"></script>
	  <script src="/assets-backend/dist/js/dashboard-data.js"></script>
	  @yield('extra-js')
</body>
